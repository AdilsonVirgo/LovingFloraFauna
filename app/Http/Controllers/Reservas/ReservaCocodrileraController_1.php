...
class ReservaCocodrileraController extends Controller {
    ...
    public function store(Request $request) {
        ...
        if ($retorno) {
            ...
            return back()->with('status', '-' . __('Reserva NO  insertada'));
        }
    }
    ...
    /* nameForm, cocodrileraForm, mercadoForm,
      totalForm, nacForm, planForm,
      fechaEForm, fechaSForm, activaForm) */

    public function DispoCOCO1($nameForm, $cocodrileraForm,
            $mercadoForm, $totalForm, $nacForm, $planForm,
            $fechaEForm, $fechaSForm, $activaForm) {
    ...
    public function DispoCOCO($nameForm, $cocodrileraForm, $mercadoForm, $totalForm, $nacForm, $planForm, $fechaEForm, $fechaSForm, $activaForm) {
        $watchtidx = $cocodrileraForm;
        $watchtypex = "App\Cocodrilera";
        $reservablex = "App\ReservaCocodrilera";
        $plan = $planForm;
...
//          $cumpletodo = $this->PasoTodo($nameReserva, $clienteReserva, $pilagente_idReserva, $fecha_entrada, $fecha_salida, $first, $second, $servicio_id);
//          return $cumpletodo; 
        if ($this->ONEDAYDISPO($nameForm, $cocodrileraForm,
                        $mercadoForm, $totalForm, $nacForm, $planForm,
                        $fechaEForm, $fechaSForm, $activaForm)) {
